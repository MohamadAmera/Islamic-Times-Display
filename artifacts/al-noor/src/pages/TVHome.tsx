...
export default function TVHome() {
  ...
  return (
    <div
      ...
      style={{
        fontFamily: "'Outfit', 'Amiri', 'Noto Naskh Arabic', sans-serif",
      }}
    >
        ...
        >
          <div
            ...
            style={{
              ...
              color: "#d6a93e",
              textShadow: "0 0 60px rgba(214,169,62,0.8)",
              lineHeight: 1.1,
            }}
          >
            الله أكبر
        ...
        <div className="flex flex-col items-end" style={{ minWidth: "28%" }}>
          ...
          <button
            ...
            style={{
              ...
              padding: "5px 16px",
              borderRadius: 8,
              background: "rgba(214,169,62,0.15)",
              color: "#d6a93e",
      ...
      {/* ══════ MAIN CONTENT ══════ */}
      <main
        className="flex-1 flex gap-0 z-10 overflow-hidden"
        style={{ minHeight: 0 }}
      >
        ...
        >
          ...
          <div
            style={{
              ...
              height: 2,
              background:
                "linear-gradient(to right, transparent, #d6a93e, transparent)",
              borderRadius: 2,
            }}
          />
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <div
                        style={{
                          ...
                          color: isNext ? "rgba(214,169,62,0.7)" : "#9ca19d",
                          letterSpacing: "0.2em",
                          textTransform: "uppercase",
                          fontFamily: "'Outfit', sans-serif",
                        }}
                      ...
                      {isNext && (
                        <span
                          style={{
                            ...
                            padding: "4px 12px",
                            borderRadius: 20,
                            background: "rgba(214,169,62,0.2)",
                            color: "#d6a93e",
                            fontWeight: 700,
                            whiteSpace: "nowrap",
                          }}
                        ...
                        <>
                          <span
                            style={{
                              ...
                              padding: "4px 12px",
                              borderRadius: 20,
                              background: "rgba(156,161,157,0.3)",
                              color: "#9ca19d",
                              fontWeight: 700,
                              letterSpacing: "0.1em",
                              textTransform: "uppercase",
                          ...
                          <span
                            style={{
                              ...
                              padding: "4px 12px",
                              borderRadius: 20,
                              background: "rgba(156,161,157,0.15)",
                              color: "#9ca19d",
                              fontWeight: 700,
                            }}
                          >
